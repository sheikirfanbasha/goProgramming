...
func TestConnect(t *testing.T) {
	fmt.Println("TestConnect: starting...\n")
	...
	defer ldap.Close()
	fmt.Println("TestConnect: finished...\n")
}
func TestSearch(t *testing.T){
	fmt.Println("TestSearch: starting...\n")
	ldap, err := openldap.Initialize(url)
	...
	fmt.Println("TestSearch: finished...\n")
}

func TestAddEntry(t *testing.T){
	fmt.Println("TestAddEntry: starting...\n")
	ldap, err := openldap.Initialize(url)
   ...
   m["objectclass"] = []string{
	...
	fmt.Println(t);
	fmt.Println("TestAddEntry: finished...\n")
}
